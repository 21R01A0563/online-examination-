...
public class exam{
  ...
  public static void main(String[] args) {
    ...
    private static void startExam(Scanner scanner) {
        ...
        for (int i = 1; i <=1; i++) {
            System.out.println("\nQuestion " + "1" + ":What is the purpose of the super keyword in Java?");
            System.out.print("a)It is used to access the superclass's constructor.  b) It is used to access the subclass's constructor.  c) It is used to call methods of the superclass d) It is used to call methods of the subclass. give answers \nYour answer: ");
